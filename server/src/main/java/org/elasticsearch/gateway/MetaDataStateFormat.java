...
public abstract class MetaDataStateFormat<T> {
     ...
     */
    public Tuple<T, Long> loadLatestState(Logger logger, NamedXContentRegistry namedXContentRegistry, Path... dataLocations) throws
            IOException {
        long generation = findMaxStateId(prefix, dataLocations);
